# ChatApp
Developed a real-time chat web application using JavaScript and Firebase. Implemented secure user authentication and real-time messaging using Firebase Authentication and Firestore. This project helped me gain hands-on experience with React state management, database integration, and building interactive web applications.
# Live Chat Application
Overview
This project is a real-time chat web application built using JavaScript and Firebase. It allows users to authenticate, send messages, and communicate in real time through a simple and responsive chat interface.
...
Integrating Firebase authentication and Firestore database

Handling real-time data updates

This project was developed as a learning project to understand React and Firebase integration for real-time applications.
